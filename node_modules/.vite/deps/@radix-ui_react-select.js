...
var Slot2 = React14.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime10.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime10.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React14.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React14.isValidElement(child) && child.type === Slottable2;
}
